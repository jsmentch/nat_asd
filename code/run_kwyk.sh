...
#to run:  sbatch --array=0-99 run_kwyk.sh
...
#parcel='A1'
cd /om2/scratch/tmp/jsmentch/kwyk/output

# #HBN
# singularity run -B /nese -B /om2 -B $(pwd):/data -W /data --nv /om2/scratch/tmp/jsmentch/kwyk.simg -m bvwn_multi_prior -n 2 --save-entropy /nese/mit/group/sig/projects/hbn/hbn_bids/sub-${sub}/ses-HBNsiteRU/anat/sub-${sub}_ses-HBNsiteRU_acq-HCP_T1w.nii.gz ${sub}
